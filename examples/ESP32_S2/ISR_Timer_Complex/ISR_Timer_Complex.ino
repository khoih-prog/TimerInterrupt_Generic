...
void setup()
{
  ...
  ESP32_ISR_Timer.setInterval(5000L, doingSomething5s);
  ESP32_ISR_Timer.setInterval(11000L, doingSomething11s);
  ESP32_ISR_Timer.setInterval(101000L, doingSomething101s);
