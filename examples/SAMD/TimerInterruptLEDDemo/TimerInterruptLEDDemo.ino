...
void setup()
{
  ...
  SAMD_ISR_Timer.setInterval(TIMER_INTERVAL_1S,  doingSomething1);
  SAMD_ISR_Timer.setInterval(TIMER_INTERVAL_2S,  doingSomething2);
  SAMD_ISR_Timer.setInterval(TIMER_INTERVAL_5S,  doingSomething3);
}
