...
3. Install [**TimerInterrupt_Generic** library](https://platformio.org/lib/show/xxxxx/TimerInterrupt_Generic) by using [Library Manager](https://platformio.org/lib/show/xxxxx/TimerInterrupt_Generic/installation). Search for **TimerInterrupt_Generic** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
